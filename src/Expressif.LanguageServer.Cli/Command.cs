...
using Expressif.LanguageServer.Core;
using Expressif.LanguageServer.Core.SourceParsers;
using Expressif.LanguageServer.Core.TemplateEngines;
using Microsoft.Extensions.Logging;

namespace Expressif.LanguageServer.Cli;
public class Command : RootCommand
{
    public Command(RenderOptions options, ILogger<RenderCommand>? logger = null)
        : base("Expressif.LanguageServer Command Line Interface")
    {
