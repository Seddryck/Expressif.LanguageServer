---
title: Using Multiple Sources in Expressif.LanguageServer
tags: [cli-usage]
---
...
```powershell
expressif.LanguageServer -t template.html -s user:user.yaml;settings:config.json -o output.html
```
...
With this approach, Expressif.LanguageServer provides flexibility in managing multi-source data, making it easy to build robust, organized models for dynamic template generation.